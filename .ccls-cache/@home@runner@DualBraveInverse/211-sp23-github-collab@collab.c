...
void awill275_syera3(){
    printf("Aaron Willming and Satyadev Yeramati\n");
    printf("We learned that you can clone a repository from github onto a "
      "connected IDE such as replit using the clone command.\n"
      "In this program we used 'git clone https://github.com/ekidane/211-sp23-github-collab'\n");
}
